...
@Component
public class SpeechMessageHandler implements WebSocketMessageHandler {
	private static final Logger logger = LoggerFactory.getLogger(SpeechMessageHandler.class);
